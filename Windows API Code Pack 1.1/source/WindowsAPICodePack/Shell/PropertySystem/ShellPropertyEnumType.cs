...
namespace Microsoft.WindowsAPICodePack.Shell.PropertySystem {
	...
	public class ShellPropertyEnumType {
		...
		private BExplorer.Shell.Interop.PropEnumType? enumType;
		...
		/// </summary>
		public BExplorer.Shell.Interop.PropEnumType EnumType {
			get {
				if (!enumType.HasValue) {
					BExplorer.Shell.Interop.PropEnumType tempEnumType;
