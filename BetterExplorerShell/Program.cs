    ...
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            if (!ExecuteControlPanelItem(args[0]))
            {
                ...
                var procStartInfo = new System.Diagnostics.ProcessStartInfo(bexplorerPath, $"\"{args[0]}\"");

                // Now we create a process, assign its ProcessStartInfo and start it
                new System.Diagnostics.Process() { StartInfo = procStartInfo }.Start();
            }
        }
        ...
        static public bool ExecuteControlPanelItem(String cmd)
        {
            ...
            var procStartInfo = new System.Diagnostics.ProcessStartInfo(explorerPath, $"shell:{cmd}");
