...
namespace ShellControls.ShellListView {
  ...
  public class VirtualGrouping : IOwnerDataCallback {
    ...
    public void GetItemPosition(int i, out BExplorer.Shell.Interop.POINT pt) { throw new NotImplementedException(); }

    public void SetItemPosition(int t, BExplorer.Shell.Interop.POINT pt) { throw new NotImplementedException(); }

    public void GetItemGroupCount(int itemIndex, out int occurrenceCount) => occurrenceCount = 1;

    public void OnCacheHint(BExplorer.Shell.Interop.LVITEMINDEX i, BExplorer.Shell.Interop.LVITEMINDEX j) { }
