...
namespace BExplorer.Shell {
  ...
  /// </summary>
  public partial class DeleteNotificationDialog : UIWindow {
    ...
    public static Boolean? ShowNotificationDialog(IListItemEx[] items) {
      ...
      if (countItems == 1) {
        ...
        if (firstItem.IsFolder) {
          ...
          var dateModified = firstItem.GetPropertyValue(SystemProperties.DateModified, typeof(DateTime)).Value;
    ...
    private void DeleteNotificationDialog_OnLoaded(object sender, RoutedEventArgs e) {
