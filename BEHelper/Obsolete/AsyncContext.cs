...
namespace BEHelper {
	...
	public class AsyncContext : IAsyncContext {
		...
		public SynchronizationContext AsynchronizationContext { get { return _asynchronizationContext; } }

		/// <summary>Test if the current executing thread is the creator thread</summary>
		public bool IsAsyncCreatorThread { get { return SynchronizationContext.Current == AsynchronizationContext; } }
