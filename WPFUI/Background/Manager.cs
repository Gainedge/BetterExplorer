    ...
    public static class Manager
    {
        ...
        private static bool RemoveTitleBar(IntPtr handle)
        {
            ...
            try
            {
                ...
                //User32.SetWindowLong(handle, -16, User32.GetWindowLong(handle, -16) & ~0x00C00000);
                //User32.SetWindowLong(handle, -16, User32.GetWindowLong(handle, -16) & ~0x02000000);
                //User32.SetWindowLong(handle, -16, User32.GetWindowLong(handle, -16) & ~0x00040000);
                //User32.SetWindowLong(handle, -16, User32.GetWindowLong(handle, -16) | 0x00C00000);
                //User32.SetWindowLong(handle, -20, User32.GetWindowLong(handle, -20) & ~(0x00000200 | 0x00000100));
                //User32.SetWindowLong(handle, -16, User32.GetWindowLong(handle, -16) | (0x80000000 | 0x00800000 | 0x00080000));
