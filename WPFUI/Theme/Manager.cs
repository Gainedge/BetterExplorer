...
namespace WPFUI.Theme {
  ...
  public static class Manager {
    ...
    /// </summary>
    public static void SetSystemTheme(BackgroundType backgroundType = BackgroundType.Default) {
      Switch(null, GetSystemTheme(), backgroundType);
    }
    ...
    /// </summary>
    public static void Switch(Window window, Style theme, BackgroundType backgroundType = BackgroundType.Default) {
      ...
      for (int i = 0; i < applicationDictionaries.Count; i++) {
        if (applicationDictionaries[i].Source != null) {
          ...
          if (sourceUri.Contains(LibraryNamespace) && sourceUri.Contains("theme")) {
            ...
            UpdateApplicationBackground(window, theme, backgroundType);
    ...
    /// </summary>
    private static void UpdateApplicationBackground(Window window, Style theme, BackgroundType backgroundType = BackgroundType.Mica) {
      ...
      if (backgroundType != BackgroundType.Default && WPFUI.Background.Manager.IsSupported(backgroundType)) {
        mainWindow.Background = Brushes.Transparent;
        WPFUI.Background.Manager.Apply(backgroundType, mainWindowHandle);
      }
    }
