...
namespace WPFUI.Theme
{
    ...
    public static class Manager
    {
        ...
        {
            Switch(null, GetSystemTheme(), useMica);
        }
        ...
        /// </summary>
        public static void Switch(Window window, Style theme, bool useMica = false)
        {
            ...
            for (int i = 0; i < applicationDictionaries.Count; i++)
            {
                if (applicationDictionaries[i].Source != null)
                {
                    ...
                    if (sourceUri.Contains(LibraryNamespace) && sourceUri.Contains("theme"))
                    {
                        ...
                        UpdateApplicationBackground(window, theme, useMica);
        ...
        /// </summary>
        private static void UpdateApplicationBackground(Window window, Style theme, bool useMica = true)
        {
