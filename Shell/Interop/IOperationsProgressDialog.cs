...
namespace BExplorer.Shell.Interop {
	...
	public interface IOperationsProgressDialog {
		...
		[PreserveSig]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		void UpdateLocations([In]IShellItem psiSource, [In]IShellItem psiTarget, [In]IShellItem psiItem);
		[PreserveSig]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		void ResetTimer();
		[PreserveSig]
		...
		[PreserveSig]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		void GetMilliseconds([In, Out] ref ulong pullElapsed, [In, Out] ref ulong pullRemaining);
		[PreserveSig]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
