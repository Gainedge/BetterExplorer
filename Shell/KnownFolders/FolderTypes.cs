...
namespace GongSolutions.Shell
{
    ...
    internal static class FolderTypes
    {
        ...
        static FolderTypes()
        {
            ...
            types.Add(Invalid, "folderType invalid");
            types.Add(Communications, "");
            types.Add(CompressedFolder, "");
            types.Add(Contacts, "");
            types.Add(ControlPanelCategory, "");
            types.Add(ControlPanelClassic, "");
            types.Add(Documents, "");
            types.Add(Games, "");
            types.Add(GenericSearchResults, "");
            types.Add(GenericLibrary, "");
            types.Add(Library, "");
            types.Add(Music, "");
            types.Add(MusicIcons, "");
            types.Add(NetworkExplorer, "");
            types.Add(OtherUsers, "");
            types.Add(OpenSearch, "");
            types.Add(Pictures, "");
            types.Add(Printers, "");
            types.Add(RecycleBin, "");
            types.Add(RecordedTV, "");
            types.Add(SoftwareExplorer, "");
            types.Add(SavedGames, "");
            types.Add(SearchConnector, "");
            types.Add(Searches, "");
            types.Add(UsersLibraries, "");
            types.Add(UserFiles, "");
            types.Add(Videos, "");
        }
