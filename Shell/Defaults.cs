...
namespace BExplorer.Shell
{
	public static class Defaults
	{
		public static void AddDefaultColumns(this ShellView shellView)
		{
			...
			User32.SendMessage(shellView.LVHandle, MSG.LVM_INSERTCOLUMN, 0, ref column);
			...
			User32.SendMessage(shellView.LVHandle, MSG.LVM_INSERTCOLUMN, 1, ref column2);
			...
			User32.SendMessage(shellView.LVHandle, MSG.LVM_INSERTCOLUMN, 2, ref column3);
			...
			User32.SendMessage(shellView.LVHandle, MSG.LVM_INSERTCOLUMN, 3, ref column4);
