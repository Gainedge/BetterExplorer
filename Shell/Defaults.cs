...
{"A0", new Tuple<String, PROPERTYKEY, Type>("Name", new PROPERTYKEY(){fmtid = Guid.Parse("b725f130-47ef-101a-a5f1-02608c9eebac"), pid = 10}, typeof(String))},
{"A1", new Tuple<String, PROPERTYKEY, Type>("Size", new PROPERTYKEY(){fmtid = Guid.Parse("b725f130-47ef-101a-a5f1-02608c9eebac"), pid = 12}, typeof(String))},
...
{"A3", new Tuple<String, PROPERTYKEY, Type>("Date modified", new PROPERTYKEY(){fmtid = Guid.Parse("b725f130-47ef-101a-a5f1-02608c9eebac"), pid = 14}, typeof(String))},
{"A4", new Tuple<String, PROPERTYKEY, Type>("Date created", new PROPERTYKEY(){fmtid = Guid.Parse("b725f130-47ef-101a-a5f1-02608c9eebac"), pid = 15}, typeof(String))},
{"A5", new Tuple<String, PROPERTYKEY, Type>("Date accessed", new PROPERTYKEY(){fmtid = Guid.Parse("b725f130-47ef-101a-a5f1-02608c9eebac"), pid = 16}, typeof(String))},
...
{"A15", new Tuple<String, PROPERTYKEY, Type>("Year", new PROPERTYKEY(){fmtid = Guid.Parse("56a3372e-ce9c-11d2-9f0e-006097c686f6"), pid = 5}, typeof(String))},
