...
namespace BetterExplorer
{
    ...
    public class SystemMenu
    {
        ...
        */
        ...
        public bool InsertSeparator(int Pos) => InsertMenu(Pos, ItemFlags.mfSeparator | ItemFlags.mfByPosition, 0, "");
        */
        ...
        public bool InsertMenu(int Pos, int ID, String Item) => InsertMenu(Pos, ItemFlags.mfByPosition | ItemFlags.mfString, ID, Item);
        */
        ...
        public bool InsertMenu(int Pos, ItemFlags Flags, int ID, String Item) => apiInsertMenu(m_SysMenu, Pos, (Int32)Flags, ID, Item) == 0;
        */
        ...
        /*
        /// <summary>Retrieves a new object from a Form object</summary>
        ...
        */
        ...
        public static void ResetSystemMenu(Form Frm) => apiGetSystemMenu(Frm.Handle, 1);


        // Checks if an ID for a new system menu item is OK or not
        public static bool VerifyItemID(int ID) => ID < 0xF000 && ID > 0;
        */
    }
