...
namespace BetterExplorer
{
    ...
    {
        public static bool isStartMinimized = false, isStartWithStartupTab = false;
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            if ((e.Args?.Any()).Value) //if (e.Args != null && e.Args.Any())
            {
        ...
        private void SingleInstanceCallback(object sender, InstanceCallbackEventArgs args)
        {
            ...
            Action<bool> d = (bool x) =>
            {
                ...
                if ((args?.CommandLineArgs?.Any()).Value) return; //TODO: Test
                if (win == null) return;
