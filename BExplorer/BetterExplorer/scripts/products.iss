...
german.depdownload_msg=Die folgenden Programme werden benötigt bevor das Setup fortfahren kann:%n%n%1%nJetzt downloaden und installieren?

english.depdownload_memo_title=Download dependencies
german.depdownload_memo_title=Abhängigkeiten downloaden

english.depinstall_memo_title=Install dependencies
german.depinstall_memo_title=Abhängigkeiten installieren

english.depinstall_title=Installing dependencies
german.depinstall_title=Installiere Abhängigkeiten

english.depinstall_description=Please wait while Setup installs dependencies on your computer.
german.depinstall_description=Warten Sie bitte während Abhängigkeiten auf Ihrem Computer installiert wird.

english.depinstall_status=Installing %1...
german.depinstall_status=Installiere %1...

english.depinstall_missing=%1 must be installed before setup can continue. Please install %1 and run Setup again.
german.depinstall_missing=%1 muss installiert werden bevor das Setup fortfahren kann. Bitte installieren Sie %1 und starten Sie das Setup erneut.
...
german.depinstall_error=Ein Fehler ist während der Installation der Abghängigkeiten aufgetreten. Bitte starten Sie den Computer neu und führen Sie das Setup erneut aus oder installieren Sie die folgenden Abhängigkeiten per Hand:%n

english.isxdl_langfile=english.ini
german.isxdl_langfile=german2.ini
