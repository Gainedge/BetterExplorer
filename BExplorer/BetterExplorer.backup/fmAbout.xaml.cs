...
{
    /// <summary>
    /// Interaction logic for fmAbout.xaml
    /// </summary>
    public partial class fmAbout : Window
    {
        /// <summary>
        ...
        /// <summary>
        /// Constructor that takes a parent for this fmAbout dialog.
        /// </summary>
        /// <param name="parent">Parent window for this dialog.</param>
        public fmAbout(Window parent)
            : this()
        {
            this.Owner = parent;
        }
